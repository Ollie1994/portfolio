...
Push to `main` → GitHub Actions workflow in `.github/workflows/` → Azure Static Web Apps.
The workflow is generated by Azure when the resource is created; its path settings must be:
